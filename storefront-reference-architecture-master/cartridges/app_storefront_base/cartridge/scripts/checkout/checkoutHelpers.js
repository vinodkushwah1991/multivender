...
function createOrder(currentBasket) {
    ...
    try {
        order = Transaction.wrap(function () {
            // need to change bcoz it is updating the default inventory
            return OrderMgr.createOrder(currentBasket);
        });
        // as per the vendors we deduct the products available from the particular inventory of the vendor.
