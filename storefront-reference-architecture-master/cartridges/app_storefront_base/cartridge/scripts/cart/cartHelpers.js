...
function addLineItem(
    ...
    try {
            ...
            productLineItem.custom.priceListId = req.form.testval2;
            productLineItem.custom.sellerRefId = "mvSellerrefID";
            productLineItem.custom.inventoryListId = "mvInventoryID";
 ...
 */
function addProductToCart(currentBasket, productId, quantity, childProducts, options,sellerBasic,testval2) {
    var availableToSell;
