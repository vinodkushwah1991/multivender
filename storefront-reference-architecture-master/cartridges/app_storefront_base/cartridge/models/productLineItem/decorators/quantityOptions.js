...
function getMinMaxQuantityOptions(productLineItem, quantity) {
    var availableToSell = productLineItem.product.availabilityModel.inventoryRecord ? productLineItem.product.availabilityModel.inventoryRecord.ATS.value : "";
    var perpetual = productLineItem.product.availabilityModel.inventoryRecord ? productLineItem.product.availabilityModel.inventoryRecord.perpetual : "";
    var max;
