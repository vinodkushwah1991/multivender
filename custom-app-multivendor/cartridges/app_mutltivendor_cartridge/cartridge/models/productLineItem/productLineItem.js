 ...
 */
module.exports = function productLineItem(product, apiProduct, options,sellerBasic) {
    ...
    product.priceListId = options.lineItem.custom.priceListId;
    product.sellerRefId = options.lineItem.custom.sellerRefId;
    product.inventoryListId = options.lineItem.custom.inventoryListId;
    product.shippingMethodId= options.lineItem.custom.shippingMethodId;
    product.companyName= options.lineItem.custom.companyName;
